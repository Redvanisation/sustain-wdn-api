class ApplicationController < ActionController::API
  ...
  def authenticate_cookie
    ...
    if decoded_token
      user = User.find_by(id: decoded_token["user_email"]) || Facilitator.find_by(id: decoded_token["facilitator_id"]) || Organization.find_by(id: decoded_token["organization_id"]) 
    end
